...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/Page1StyleSheet.css">
...
<body>
    ...
    <main>
        <svg class="devellopement" width="888" height="84" viewBox="0 0 888 84" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <circle cx="38" cy="38" r="38" transform="matrix(-1 0 0 1 346 8)" fill="#EFF0F6"/>
            ...
            <circle cx="38" cy="38" r="38" transform="matrix(-1 0 0 1 617 8)" fill="#EFF0F6"/>
            ...
            <rect x="91" y="40" width="165" height="13" rx="6.5" fill="#EFF0F7"/>
            <rect x="91" y="40" width="100" height="13" rx="6.5" fill="#0D912E"/>
        </svg>
        <h1 class="titreListe">Choisissez un stage</h1>
