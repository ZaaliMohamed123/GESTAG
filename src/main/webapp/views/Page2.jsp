...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/Page2StyleSheet.css">
    <title>Inscription Stage - Liste des Inscrits</title>
</head>
<body>
	<header>
        <div class="header">
    ...
    <main>
        <svg  class="devellopement" width="888" height="84" viewBox="0 0 888 84" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="362" y="40" width="100" height="13" rx="6.5" fill="#0D912E"/>
        </svg>
        <%
